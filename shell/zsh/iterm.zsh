...
alias imgcat=${HOME}/.config/iterm2/scripts/imgcat;alias imgls=${HOME}/.config/iterm2/scripts/imgls;alias it2api=${HOME}/.config/iterm2/scripts/it2api;alias it2attention=${HOME}/.config/iterm2/scripts/it2attention;alias it2check=${HOME}/.config/iterm2/scripts/it2check;alias it2copy=${HOME}/.config/iterm2/scripts/it2copy;alias it2dl=${HOME}/.config/iterm2/scripts/it2dl;alias it2getvar=${HOME}/.config/iterm2/scripts/it2getvar;alias it2git=${HOME}/.config/iterm2/scripts/it2git;alias it2setcolor=${HOME}/.config/iterm2/scripts/it2setcolor;alias it2setkeylabel=${HOME}/.config/iterm2/scripts/it2setkeylabel;alias it2tip=${HOME}/.config/iterm2/scripts/it2tip;alias it2ul=${HOME}/.config/iterm2/scripts/it2ul;alias it2universion=${HOME}/.config/iterm2/scripts/it2universion;alias it2profile=${HOME}/.config/iterm2/scripts/it2profile;alias it2cat=${HOME}/.config/iterm2/scripts/it2cat
